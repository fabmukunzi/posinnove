        ...
        <div className='flex w-full max-sm:flex-col'>
            ...
            <div className='w-[40%] max-md:w-full justify-center flex flex-col gap-8'>
                ...
                <div className='flex justify-between gap-4 w-[90%] max-md:w-full'>
                    <Button onPress={() => handleClick("https://form.jotform.com/241956791680570")} className='text-white max-md:px-14 bg-primary w-52' size='lg'>Join as organization</Button>
                    <Button onPress={() => handleClick("https://app.posinnove.com/login")} variant="bordered" className='bg-white w-52 border-primary text-primary' size='lg'>Get started</Button>
                </div>
